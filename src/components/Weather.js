  ...
  return (
    <div className="weather-container">
      <div className="weather-input">
        <div className="input-box"> {/* Added white box for input */}
        ...
        <div className="favorite-info">
          ...
          <button onClick={() => { setFavoriteCity(''); localStorage.removeItem('favoriteCity'); setIsFavorite(false); }}>Remove Favorite City</button>
        ...
        {weatherData && (
          <>
            <div className="weather-display">
              <div className="current-weather">
                ...
                <h2 style={{ fontSize: '3rem' }}>
                  {unit === 'F' ? weatherData.current.temp_f : weatherData.current.temp_c} °{unit}
                </h2>
                <img
            ...
            <div className="forecast">
              <h3>3-5 Day Forecast:</h3>
              <div className="forecast-days">
                {forecast.map((day, index) => (
                  <div key={index} className="forecast-day">
                    <h4>{new Date(day.date).toLocaleDateString()}</h4>
                    <img src={day.day.condition.icon} alt={day.day.condition.text} />
                    <p>High: {unit === 'F' ? day.day.maxtemp_f : day.day.maxtemp_c} °{unit}</p>
                    <p>Low: {unit === 'F' ? day.day.mintemp_f : day.day.mintemp_c} °{unit}</p>
